...
const SignUp = () => {
    ...
    const fromHandaler = async (event) => {
        ...
        if (pass.length < 6) {
            ...
            setError("");
            const data = await createUser(email, pass, name);
            if (data) {
                navigate("/sign-in");
            }
            console.log(data);
            ...
            <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
                <div className="text-center">
                    ...
                    <div className="mt-5 space-y-2">
                        ...
                        <p className="">Already have an account? <Link to={'/sign-in'} className="font-medium text-indigo-600 hover:text-indigo-500">Log in</Link></p>
                    </div>
                </div>
